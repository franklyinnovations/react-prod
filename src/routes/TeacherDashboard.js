...
import reducer from '../redux/reducers/teacherdashboard';
import * as actions from '../redux/actions/teacherdashboard';
addView('teacherdashboard', reducer);
...
export default class TeacherDashboard extends React.Component {
		...
		return (
			<View className='teacher-dashboard'>
				<Row>
					...
					<Col md={4}>
						<StudentLeaves studentleaves={this.props.studentleaves}/>
					</Col>
					<Col md={4}>
	...
	componentDidMount() {
		...
		this.props.dispatch(actions.loadStudentLeaves());
...
class StudentLeaves extends React.PureComponent {
	render() {
		return (
			<div className='card'>
				<div className='card-heading'>
					<Text>Upcoming Student Leaves</Text>
					{
						this.props.studentleaves &&
						<span className='pull-right badge'>
							{this.props.studentleaves.length}
							&nbsp;
							<Text>Leave</Text>
						</span>
					}
	...
	renderLeaves() {
		if (this.props.studentleaves === null) return <Loading/>;
		if (this.props.studentleaves.length === 0)
			return (
				<Alert bsStyle='warning'>
					<Text>No record found.</Text>
				</Alert>
		...
		return (
			<Table striped>
				...
				<tbody>
					{
						this.props.studentleaves.map((item, index) =>
							<tr key={index}>
								<td>
