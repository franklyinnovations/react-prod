...
export default class JobPost extends React.Component {
	...
	search() {
		this.props.router.push('/hospital/job-post');
	}
	...
	viewList() {
		this.props.dispatch(actions.jobpost.viewList())
	}

	save() {
		this.props.dispatch(actions.jobpost.save(this.props, 1));
	}

	publish() {
		this.props.dispatch(actions.jobpost.save(this.props, 2));
	}
