...
export default class Service extends React.Component {
	constructor(props) {
        ...
        this.addNewTag = value => {
            ...
            if(newTag) this.props.dispatch( actions.doctor_profile.customTagAdd(this.props, newTag, this.tagtypeIds.ServiceTagId) )
        }
    }
            ...
            <div key={'services'}>
                ...
                <Well>
                    <div className="Select--multi">
                        ...
                        {
                            this.props.additionalInfo.services.length > 0 && 
