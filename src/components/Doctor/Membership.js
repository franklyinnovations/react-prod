...
export default class Membership extends React.Component {
	constructor(props) {
        ...
        this.addNewTag = value => {
            ...
            if(newTag) this.props.dispatch( actions.doctor_profile.customTagAdd(this.props, newTag, this.tagtypeIds.MembershipsTagId) )
        }
    }
            ...
            <div key={'memberships'}>
                ...
                <Well>
                    <div className="Select--multi">
                        ...
                        {
                            this.props.additionalInfo.memberships.length > 0 && 
                            this.props.additionalInfo.memberships.map(item => 
                                <div key={'ser-tag-label-'+item.value} className="Select-value tags-close " style={{marginLeft: '0px'}}>
