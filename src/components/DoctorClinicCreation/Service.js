...
export default class Service extends React.Component {
	constructor(props) {
        ...
        this.addNewTag = value => {
            ...
            if(newTag) this.props.state.dispatch( actions.doctor_new_clinic_add.customTagAdd(this.props, newTag, this.tagtypeIds.ServiceTagId) )
        }
    }
            ...
            <div key={'services'}>
                ...
                <FormGroup controlId="services" validationState={this.props.state.errors.services ? 'error': null}>
                    <Select
                        ...
                        isLoading={this.props.state.newTagCreationStates.serviceTagLoading}
