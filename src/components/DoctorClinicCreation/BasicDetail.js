...
export default class BasicDetail extends React.Component {
	constructor(props) {
        ...
        this.handleAddMoreEmailMobile = event => {
            ...
            this.props.state.dispatch(
                actions.doctor_new_clinic_add.addMoreEmailMobile(this.props.state, event.target.getAttribute('data-type'))
            )
        }
        ...
        this.handleContactDataUpdate = event => {
            if(event.target.getAttribute('data-action-type') === "is_primary") {
                ...
                this.props.state.dispatch(
                    actions.doctor_new_clinic_add.updateEmailMobile(
                        this.props.state, 
        ...
        this.handleRemoveContactEmailMobile = event => {
            this.props.state.dispatch(
                actions.doctor_new_clinic_add.removeEmailMobile(
                    this.props.state, 
                    event.target.getAttribute('data-type'), 
                    event.target.getAttribute('data-index')
                )
  	...
  	render() {
        if (this.props.state.loading) return <Loading/>;
