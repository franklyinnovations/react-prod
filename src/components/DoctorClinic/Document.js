...
export default class Document extends React.Component {
    ...
    render() {
        ...
        if(this.props.data.resetDocumentForm) {
            ...
            <Row key="doctor-document">
                ...
                <Col sm={12}>
                    <Row className='gallery-view'>
                        { this.props.data.hospitalFiles.images.map(this.getDataRow, this) }
                        { this.props.data.hospitalFiles.images.length === 0 && this.getNoDataRow(__, "image") }
                    </Row>
                </Col>
                <Col sm={12}>
                    <h3>{__('Videos')}</h3>
                    ...
                    <Row>
                        <Col sm={12}>
                            <Table bordered responsive>
                                ...
                                <tbody>
                                    { this.props.data.hospitalFiles.videos.map(this.getDataVideo, this) }
                                    { this.props.data.hospitalFiles.videos.length === 0 && this.getNoDataRow(__, "video") }
                                </tbody>
                            </Table>
                        </Col>
                    </Row>
    ...
    async saveImage() {
        ...
        data.append('hospitalId',this.props.data.basicDetails.id);
        this.props.data.dispatch(
            actions.doctor_clinic.saveImage(this.props.data, data)
        );
    }
