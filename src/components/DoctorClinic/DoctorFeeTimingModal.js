			...
			<Modal {...this.props} lg >
				...
				{ this.props.type === "hospital" && <Modal.Header closeButton>
					...
					{ this.props.currentHospital.hospitaldetail && <Col xs={7} md={7} lg={7}>
										{ `${this.props.currentHospital.hospitaldetail.contact_mobiles} | ${this.props.currentHospital.hospitaldetail.contact_emails}` }
										<br/> { `${this.props.currentHospital.hospitaldetail.address}, ${this.props.currentHospital.hospitaldetail.about_hospital}` }
					</Col> }
