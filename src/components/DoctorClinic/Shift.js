...
export default class Shift extends React.Component {
    ...
    save(){
        ...
        if(!isError) { 
            ...
            if(this.props.basicDetails.is_freeze == 1) {
                ...
                this.props.dispatch(
                    actions.doctor_clinic.saveTime(this.props.data, finalArr)
                );
            }
    ...
    managefreeze(name, value) {
        ...
        this.props.dispatch(
            actions.doctor_clinic.manage_freeze(
                this.props,
                value
            )
        )
    ...
    saveData(event) {
        ...
        this.props.dispatch(
            actions.doctor_clinic.saveShifTiming(this.props.data, finalArr, 'doc-fee-timings-info-form')
        );
    }
